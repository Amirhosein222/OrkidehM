  ...
  const renderRelations = function ({ item }) {
    return (
      <Card
        width="80%"
        height="150"
        bgColor={isPeriodDay ? COLORS.lightRed : COLORS.lightBlue}
        borderRadius="10">
        ...
        <View style={styles.cardContent}>
          ...
          <Text marginRight="10">{numberConverter(item.woman.mobile)}</Text>
        </View>
    ...
    <Container justifyContent="flex-start">
      ...
      <ScrollView
        ...
        <TextInput
          style={{
            ...styles.input,
            backgroundColor: isPeriodDay ? COLORS.lightRed : COLORS.lightBlue,
          }}
          onChangeText={handleTextInput}
          inputName="spouseName"
          editedText={spouseName}
          textColor={isPeriodDay ? COLORS.rossoCorsa : COLORS.blue}
          phColor={isPeriodDay ? COLORS.rossoCorsa : COLORS.blue}
        />
        <Text marginTop="20" medium bold>
          شماره موبایل همسر
        </Text>
