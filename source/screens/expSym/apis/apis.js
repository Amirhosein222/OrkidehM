...
export const getSymptomsApi = async function () {
  try {
    ...
    const res = await loginClient.get('get/all/signs?gender=man');
    return res.data;
  } catch (error) {
...
export const getExpectationsFromSpouseApi = async function (activeRel) {
  try {
    ...
    const res = await loginClient.get(
      `index/expectation?relation_id=${activeRel}&gender=man`,
    );
    return res.data;
  } catch (error) {
    // console.log('e ', error.response);
...
export const getMyExpectationsFromSpouseApi = async function (activeRel) {
  try {
    const loginClient = await getLoginClient();
    const res = await loginClient.get(
      `today/my/expectation?relation_id=${activeRel}&include_expectation=1&gender=man`,
    );
    return res.data;
  } catch (error) {
    // console.log('e ', error.response);
...
export const deleteSignApi = async function (sign) {
  try {
    const loginClient = await getLoginClient();
    const res = await loginClient.delete(`sign/${sign}?gender=man`);
...
export const deleteExpApi = async function (exp, rel) {
  try {
    ...
    const res = await loginClient.delete(
      `expectation/${exp}?gender=man&relation_id=${rel}`,
    );
    return res.data;
  } catch (error) {
    // console.log('e ', error.response);
